...
def fetch_and_process_logs():
    ...
    last_processed_time = fetch_last_processed_time() or datetime(2024, 11, 14) # Specify the start date (in yyyy-mm-dd format) from which logs should be saved to the database.
